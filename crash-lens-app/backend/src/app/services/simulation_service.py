...
class SimulationService:
    ...
    async def simulate_crash(self, request: SimulateCrashRequest) -> SimulateCrashResponse:
        ...
        error_details = self._analyze_error_from_traceback(traceback_text, request.scenario.value)
    ...
    def _analyze_error_from_traceback(self, traceback: str, scenario: str) -> Dict[str, Any]:
    ...
    async def _create_crash_entry(self, crash_id: str, request: SimulateCrashRequest, 
    ...
    def _jitter_sleep(self, min_ms: int = 40, max_ms: int = 140, enabled: bool = True) -> None:
    ...
    def _scenario_paystack_timeout(self, fmt: str, jitter: bool, prelude_count: int) -> Tuple[List[str], str]:
...
httpx.ConnectTimeout: Timed out while connecting to Paystack
    ...
    def _scenario_migration_type_mismatch(self, fmt: str, jitter: bool, prelude_count: int) -> Tuple[List[str], str]:
...
TypeError: unsupported operand type(s) for *: 'NoneType' and 'int'
    ...
    def _scenario_taskq_oversell(self, fmt: str, jitter: bool, prelude_count: int) -> Tuple[List[str], str]:
...
quantity
  oversell (type=value_error)
    ...
    def _scenario_verify_payment_timeout(self, fmt: str, jitter: bool, prelude_count: int) -> Tuple[List[str], str]:
...
httpx.ReadTimeout: Timed out while reading from Paystack
    ...
    def _scenario_db_startup_failure(self, fmt: str, jitter: bool, prelude_count: int) -> Tuple[List[str], str]:
...
core.errors.DatabaseConnectionError
    ...
    def _scenario_stripe_signature_error(self, fmt: str, jitter: bool, prelude_count: int) -> Tuple[List[str], str]:
